...
<div class="container">
    <p class="text-white text-center pt-5 display-6">目前上映電影</p>

    <div class="row ">
        <div v-for="movie in nowPlayingMovies.movies" :key="movie.id" class="col-6 col-md-3 col-xl-3">
...
<script>
import { apiNowPlayingMovie, apiAddToWatchList } from '../api/api';
...
export default {
    setup() {
        ...
        const getNowPlayingMovie = async() => {
            try{
                const response = await apiNowPlayingMovie(currentPage.value);
